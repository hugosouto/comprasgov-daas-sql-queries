...
SELECT DISTINCT
	...
	COUNT(DISTINCT pa12.ID_ITCP_ITEM_COMPRA) AS CONTA_ITEM
...
SELECT ID_DT_MES AS anomes, CAST(AVG(CONTA_FORNECEDOR) AS FLOAT) AS mediaparticipantespregao, NOW() AS datahoraregisto
FROM temp2
GROUP BY ID_DT_MES
ORDER BY ID_DT_MES
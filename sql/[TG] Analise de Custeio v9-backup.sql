...
--	MAX(a13.ID_TP_NE)						ID_TP_NE,
--	MAX(a13.ID_MODALIDADE_LICITACAO_NE)	  	ID_MODALIDADE_LICITACAO_NE,
...
--	CASE WHEN a12.ID_ITEM_INFORMACAO = 421 AND SUM(a11.VA_MOVIMENTO_LIQUIDO) <> 0 AND SUM(a11.VA_MOVIMENTO_LIQUIDO) IS NOT NULL THEN SUM(a11.VA_MOVIMENTO_LIQUIDO) ELSE 0 END DESPESAS_EMPENHADAS,
--	CASE WHEN a12.ID_ITEM_INFORMACAO = 423 AND SUM(a11.VA_MOVIMENTO_LIQUIDO) <> 0 AND SUM(a11.VA_MOVIMENTO_LIQUIDO) IS NOT NULL THEN SUM(a11.VA_MOVIMENTO_LIQUIDO) ELSE 0 END DESPESAS_PAGAS
FROM	

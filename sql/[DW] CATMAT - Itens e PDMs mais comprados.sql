...
where	(a13.ID_DT_ANO in (2022) and a14.ID_ITCP_TP_MATERIAL_SERVICO in (1))
group by	
	a13.ID_DT_ANO,
...
where	(a13.ID_DT_ANO in (2022) and a15.ID_ITCP_TP_MATERIAL_SERVICO in (1))
group by
	a11.ID_ITCP_TP_COD_MAT_SERV,
	a13.ID_DT_ANO 
), ZZSP02  as (
...
select	
	...
	a15.ID_ITCP_CLASSE_MAT_SERV_EDIT  ID_ITCP_CLASSE_MAT_SERV,
	a15.DS_ITCP_CLASSE_MAT_SERV  DS_ITCP_CLASSE_MAT_SERV,
	a13.ID_ITCP_PADRAO_DESC_MAT  ID_ITCP_PADRAO_DESC_MAT,
	a17.DS_ITCP_PADRAO_DESC_MAT  DS_ITCP_PADRAO_DESC_MAT,
--	cast(a13.ID_ITCP_MATERIAL_SERVICO as string)  ID_ITCP_MATERIAL_SERVICO,
--	a13.DS_ITCP_MATERIAL_SERVICO  DS_ITCP_MATERIAL_SERVICO,
	sum(pa11.WJXBFS1)  QTD_ITENS,
	sum(pa12.WJXBFS1)  VR_TOTAL_HOMOLOGADO,
	sum(pa11.WJXBFS1) / (select distinct count(ID_ITCP_CLASSE_MAT_SERV) from Siasg_DW_VBL.D_ITCP_MATERIAL_SERVICO where ID_ITCP_TP_MATERIAL_SERVICO = 1) PERCENTUAL_DO_TOTAL
from	ZZSP01	pa11
	join	ZZSP02	pa12
	...
	join	Siasg_DW_VBL.D_ITCP_PADRAO_DESC_MAT	a17
	  on 	(a13.ID_ITCP_PADRAO_DESC_MAT = a17.ID_ITCP_PADRAO_DESC_MAT)
group by 
	pa11.ID_DT_ANO, 
	a13.ID_ITCP_PADRAO_DESC_MAT, 
	a17.DS_ITCP_PADRAO_DESC_MAT, 
	a13.ID_ITCP_GRUPO_MATERIAL, 
	a16.DS_ITCP_GRUPO_MATERIAL, 
	a13.ID_ITCP_CLASSE_MAT_SERV, 
	a15.ID_ITCP_CLASSE_MAT_SERV_EDIT, 
	a15.DS_ITCP_CLASSE_MAT_SERV
--	a13.DS_ITCP_MATERIAL_SERVICO, 
--	a13.ID_ITCP_MATERIAL_SERVICO
order by sum(pa11.WJXBFS1) desc
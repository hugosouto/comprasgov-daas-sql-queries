...
--	sum(a11.VA_MOVIMENTO_LIQUIDO) 			MOVIMLQUIDOMOEDAORIGEMCONTACO,
	sum(case when a12.ID_ITEM_INFORMACAO = 421 and a11.VA_MOVIMENTO_LIQUIDO <> 0 and a11.VA_MOVIMENTO_LIQUIDO is not null then a11.VA_MOVIMENTO_LIQUIDO end) DESPESAS_EMPENHADAS,
	sum(case when a12.ID_ITEM_INFORMACAO = 423 and a11.VA_MOVIMENTO_LIQUIDO <> 0 and a11.VA_MOVIMENTO_LIQUIDO is not null then a11.VA_MOVIMENTO_LIQUIDO end) DESPESAS_PAGAS,
...
--	and a11.VA_MOVIMENTO_LIQUIDO IS NOT NULL

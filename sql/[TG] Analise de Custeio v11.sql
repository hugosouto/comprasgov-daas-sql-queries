...
WHERE	
	(a11.ID_CATEGORIA_ECONOMICA_NADE = 3
	 ...
	 AND a17.ID_ORGAO_MAXI IN (22000, 25000, 20103, 20105, 20113, 23000, 24000, 28000, 30000, 32000, 33000, 34000, 35000, 36000, 38000, 39000, 40000, 41000, 42000, 44000, 47000, 49000, 51000, 53000, 54000, 55000, 56000, 58000, 81000, 82000, 26000, 36000, 20000, 20101, 20114, 26455, 26457, 52000, 57000, 63000)
	 AND a12.ID_ITEM_INFORMACAO IN (423)
--	 AND a11.ID_SUBFUNCAO_PT IN (122)
	 AND a11.ID_ANO_LANC IN (2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020) --(2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020)

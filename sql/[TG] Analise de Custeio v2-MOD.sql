SELECT
	...
	max(a120.CO_ORGAO_MAXI)  				CO_ORGAO_MAXI,
	max(a120.NO_ORGAO_MAXI)  				NO_ORGAO_MAXI,
	a14.ID_ORGAO_UG  						ID_ORGAO,
	max(a121.CO_ORGAO)  					CO_ORGAO,
	max(a121.NO_ORGAO)  					NO_ORGAO,
	a15.ID_ORGAO_UO  						ID_ORGAO0,
	max(a119.CO_ORGAO)  					CO_ORGAO0,
	max(a119.NO_ORGAO)  					NO_ORGAO0,
	a11.ID_UG_RESP  						ID_UG,
	max(a118.CO_UG)  						CO_UG0,
	max(a118.NO_UG)  						NO_UG0,
	...
	max(a110.NO_FUNCAO_PT)  				ID_FUNCAO_PT0,

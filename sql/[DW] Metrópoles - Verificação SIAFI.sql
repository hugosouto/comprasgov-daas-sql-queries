...
--	a11.ID_UNDD_EMITENTE_EMPENHO				UASG,
	a19.DS_EMPN_NAT_DESPESA						DS_EMPN_NAT_DESPESA,
	a11.ID_FRND_FORNECEDOR_COMPRA				FORNECEDOR,
...
FROM	
	...
	JOIN	Siasg_DW_VBL.D_EMPN_EMPENHO					a19
	  ON 	(a11.ID_EMPN_EMPENHO = a19.ID_EMPN_EMPENHO)
...
WHERE	
	...
	AND a12.ID_DT_MES IN (201012, 201112, 201212, 201312, 201412, 201512, 201612, 201712, 201812, 201912, 202012)
	AND a19.DS_EMPN_NAT_DESPESA IN (339030)
	AND a11.ID_UNDD_EMITENTE_EMPENHO IN (130024)
-- 	AND (
...
--	a110.DS_UNDD_ORGAO_SUP,
	a11.ID_UNDD_EMITENTE_EMPENHO,
	a19.DS_EMPN_NAT_DESPESA,
...
---------------------------------------------------------------------------------------------------------- Consulta com Natureza de Despesa
	
select	a15.ID_ITCP_PADRAO_DESC_MAT  ID_ITCP_PADRAO_DESC_MAT,
	a111.DS_ITCP_PADRAO_DESC_MAT  DS_ITCP_PADRAO_DESC_MAT,
	a13.ID_UNDD_ESFERA  ID_UNDD_ESFERA,
	a17.DS_UNDD_ESFERA  DS_UNDD_ESFERA,
	a13.ID_UNDD_PODER  ID_UNDD_PODER,
	a112.DS_UNDD_PODER  DS_UNDD_PODER,
	a13.ID_UNDD_TP_ADM  ID_UNDD_TP_ADM,
	a113.DS_UNDD_TP_ADM  DS_UNDD_TP_ADM,
	a13.ID_UNDD_ORGAO_SUP  ID_UNDD_ORGAO_SUP,
	a110.DS_UNDD_ORGAO_SUP  DS_UNDD_ORGAO_SUP,
	a14.ID_EMPN_ESPECIE_EMPENHO  ID_EMPN_ESPECIE_EMPENHO,
	a18.DS_EMPN_ESPECIE_EMPENHO  DS_EMPN_ESPECIE_EMPENHO,
	a11.ID_EMPN_EMPENHO  DS_EMPN_NAT_DESPESA,
	a19.DS_EMPN_NAT_DESPESA  DS_EMPN_NAT_DESPESA0,
	a12.ID_DT_ANO  ID_DT_ANO,
...
where	(a12.ID_DT_ANO in (2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020)
 ...
 and a14.ID_EMPN_ESPECIE_EMPENHO in (1))
group by	a15.ID_ITCP_PADRAO_DESC_MAT,
	a111.DS_ITCP_PADRAO_DESC_MAT,
	a13.ID_UNDD_ESFERA,
	a17.DS_UNDD_ESFERA,
	a13.ID_UNDD_PODER,

SELECT *
FROM Stg_Comprasnet.dbo.dbo.tbl_lances
...
;
SELECT *
FROM Stg_Comprasnet.dbo.dbo.tbl_lances_encerrados
--WHERE lanData BETWEEN '2010-01-01 00:00:00' AND '2022-01-01 00:00:00'
WHERE lanData BETWEEN '2010-01-01 00:00:00' AND '2018-01-01 00:00:00'
;
WITH temp AS (
	SELECT o2.CodOrgao,o2.NomeOrgao,COUNT(l.lanCod) Lances
	FROM Stg_Comprasnet.dbo.dbo.tbl_lances l
	JOIN Stg_Comprasnet.dbo.dbo.tbl_pregaoitem pi ON pi.ipgCod = l.ipgCod
	JOIN Stg_Comprasnet.dbo.dbo.tbl_pregao p ON p.prgCod = pi.prgCod
	JOIN Stg_Comprasnet.dbo.dbo.tb_uasg u ON u.coduasg = p.coduasg
	JOIN Stg_Comprasnet.dbo.dbo.tb_orgao o ON o.CodOrgao = u.CodOrgao
	JOIN Stg_Comprasnet.dbo.dbo.tb_orgao o2 ON o2.CodOrgao= o.CodOrgaoVinculado
	WHERE l.lanData BETWEEN '2010-01-01 00:00:00' AND '2022-01-01 00:00:00'
	GROUP BY o2.CodOrgao,o2.NomeOrgao
	UNION
	SELECT o2.CodOrgao,o2.NomeOrgao,COUNT(l.lanCod) Lances
	FROM Stg_Comprasnet.dbo.dbo.tbl_Lances_Encerrados l
	JOIN Stg_Comprasnet.dbo.dbo.tbl_pregaoitem pi ON pi.ipgCod = l.ipgCod
	JOIN Stg_Comprasnet.dbo.dbo.tbl_pregao p ON p.prgCod = pi.prgCod
	JOIN Stg_Comprasnet.dbo.dbo.tb_uasg u ON u.coduasg = p.coduasg
	JOIN Stg_Comprasnet.dbo.dbo.tb_orgao o ON o.CodOrgao = u.CodOrgao
...
----------------------------------------- C�digos para o Comprasnet_VBL

SELECT COUNT(*)
FROM Stg_Comprasnet.dbo.tbl_pregaoitem
...
WITH temp AS (
	...
	JOIN Stg_Comprasnet.dbo.tb_orgao o ON o.CodOrgao = u.CodOrgao
	JOIN Stg_Comprasnet.dbo.tb_orgao o2 ON o2.CodOrgao= o.CodOrgaoVinculado
	WHERE l.lanData BETWEEN '2010-01-01 00:00:00' AND '2018-01-01 00:00:00' AND o2.CodOrgao IN (95430)
	GROUP BY o2.CodOrgao,o2.NomeOrgao
	UNION
	SELECT o2.CodOrgao,o2.NomeOrgao,COUNT(l.lanCod) Lances
	FROM Stg_Comprasnet.dbo.tbl_Lances_Encerrados l

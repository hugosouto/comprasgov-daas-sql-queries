...
FROM	
	...
	JOIN	DWTG_Colunar_VBL.WD_MUNICIPIO				a123
	  ON 	(a110.ID_MUNICIPIO_UG = a123.ID_MUNICIPIO)	  
WHERE	
		  (a110.ID_MOEDA_UG 					IN (790)
	 AND  a12.ID_ITEM_INFORMACAO 			IN (61) -- (423)
	 ...
	 AND  a17.ID_ORGAO_MAXI 				IN (36000, 52000, 25000, 26000, 30000, 39000, 24000, 22000)	-- (22000, 25000, 20103, 20105, 20113, 23000, 24000, 28000, 30000, 32000, 33000, 34000, 35000, 36000, 38000, 39000, 40000, 41000, 42000, 44000, 47000, 49000, 51000, 53000, 54000, 55000, 56000, 58000, 81000, 82000, 26000, 36000, 20000, 20101, 20114, 26455, 26457, 52000, 57000, 63000)
	 AND  a11.ID_ANO_LANC 					IN (2015, 2016, 2017, 2018, 2019, 2020) 	-- (2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020)
--	 AND  a11.ID_SUBFUNCAO_PT 				IN (122)
--	 AND  a11.ID_MES_LANC 					IN (1, 2)
--	 AND  a13.ID_TP_NE 						IN (3)
--	 AND  a11.VA_MOVIMENTO_LIQUIDO 			<> 0 
--	 AND  a110.ID_ESFERA_ADMIN_UG 			IN (0)
--	 AND  a119.ID_PODER_ORGAO 				IN (0)
--	 AND  a119.ID_TP_ADMIN_ORGAO 			IN (1, 3, 4)
	)
GROUP BY	

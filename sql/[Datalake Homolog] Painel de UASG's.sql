...
CASE IT_NU_CGC_CPF
	...
	END IT_NU_CGC_CPF,
IT_CO_UNIDADE_GESTORA, --Formatação para 6 dígitos, com zeros à esquerda: RIGHT(REPLICATE('0', 6) + RTRIM(IT_CO_UNIDADE_GESTORA),6) IT_CO_UNIDADE_GESTORA
IT_NO_UNIDADE_GESTORA,
CASE IT_IN_USO_SISG_UASG
	WHEN 'S' THEN 'Sim'
	WHEN 'N' THEN 'Não'
	END IT_IN_USO_SISG_UASG,
CASE IT_IN_ADESAO_SIASG
	WHEN 'S' THEN 'Sim'
	WHEN 'N' THEN 'Não'
	END IT_IN_ADESAO_SIASG,
IT_DA_MOVIMENTO,
CASE IT_DA_IMPLANTACAO_SIDEC
	WHEN '0' THEN NULL
	ELSE IT_DA_IMPLANTACAO_SIDEC
	END IT_DA_IMPLANTACAO_SIDEC,
IT_SG_UF,
SG_UF,
...
CASE CAST(IT_IN_TIPO_PODER AS VARCHAR)
	...
	END IT_IN_TIPO_PODER,
CASE IT_IN_ESFERA
	WHEN 'M' THEN 'Municipal'
	WHEN 'E' THEN 'Estadual'
	WHEN 'F' THEN 'Federal'
	WHEN '' THEN NULL
	ELSE IT_IN_ESFERA END IT_IN_ESFERA

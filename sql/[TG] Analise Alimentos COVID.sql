...
--	join	DWTG_Colunar_VBL.WD_DOC_NE_ITEM 	a115
--	  on	a11.ID_DOCUMENTO_CCOR_ORCA = a115.ID_DOC_NE
where	(
...
-- )))))
   a19.CO_NATUREZA_DESPESA_DETA in (33903007)
...
-- and a15.ID_ORGAO_MAXI in (52000)
 and a13.ID_UG in (120628)
 and a16.ID_MOEDA_UG in (790)
-- and a11.ID_ANO_LANC in (2020, 2019, 2018, 2017, 2016, 2015)
-- and a11.ID_ACAO_PT in ('21C0')

...
--	REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a111.DS_ITCP_PADRAO_DESC_MAT, '"', ''), '*', ''), 'DE PIPOCA', 'PIPOCA'), ' - ', ' '), 'PORCO', 'SUÍNA'), 'FARINHA TRIGO', 'FARINHA DE TRIGO'), 'FARINHA MILHO', 'FARINHA DE MILHO'), 'FARINHA MANDIOCA', 'FARINHA DE MANDIOCA'), 'LEITE PÓ', 'LEITE EM PÓ'), 'ÁGUA MINERAL NATURAL','ÁGUA MINERAL'), 'ÁGUA MINERAL', 'ÁGUA MINERAL NATURAL'), 'IOGURTE NATURAL', 'IOGURTE'), 'IOGURTE', 'IOGURTE NATURAL'), 'PEIXE CONSERVA', 'PEIXE EM CONSERVA'),
...
--	a111.DS_ITCP_PADRAO_DESC_MAT LIKE '"VERDURA IN%NATURA"' OR  ---------------------------------------------
	...
	a111.DS_ITCP_PADRAO_DESC_MAT LIKE 'PÓ PUDIM*' OR
	a111.DS_ITCP_PADRAO_DESC_MAT LIKE 'SORVETE*' OR
	a111.DS_ITCP_PADRAO_DESC_MAT LIKE 'VERDURA IN%NATURA*'
	))
group by
--	REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a111.DS_ITCP_PADRAO_DESC_MAT, '"', ''), '*', ''), 'DE PIPOCA', 'PIPOCA'), ' - ', ' '), 'PORCO', 'SUÍNA'), 'FARINHA TRIGO', 'FARINHA DE TRIGO'), 'FARINHA MILHO', 'FARINHA DE MILHO'), 'FARINHA MANDIOCA', 'FARINHA DE MANDIOCA'), 'LEITE PÓ', 'LEITE EM PÓ'), 'ÁGUA MINERAL NATURAL','ÁGUA MINERAL'), 'ÁGUA MINERAL', 'ÁGUA MINERAL NATURAL'), 'IOGURTE NATURAL', 'IOGURTE'), 'IOGURTE', 'IOGURTE NATURAL'), 'PEIXE CONSERVA', 'PEIXE EM CONSERVA')--	a15.ID_ITCP_PADRAO_DESC_MAT,
	a111.DS_ITCP_PADRAO_DESC_MAT
--	a111.DS_ITCP_PADRAO_DESC_MAT
--	a13.ID_UNDD_ESFERA,
--	a17.DS_UNDD_ESFERA,

...
JOIN credenciamento_pncp.atividade_principal a ON a.cnpj_atividade_principal = c.cnpj
JOIN credenciamento_pncp.natureza_juridica n ON n.cnpj_natureza_juridica = c.cnpj
ORDER BY id
;

...
where	a13.ID_DT_ANO in (2018, 2019, 2020, 2021, 2022, 2023)
...
where	a14.ID_DT_ANO in (2018, 2019, 2020, 2021, 2022, 2023)
group by	a12.ID_CMPR_COMPRA 
), ZZSP02  as (
select	a12.ID_CMPR_COMPRA  DS_CMPR_COMPRA_EDIT,
	sum(a11.QT_COMPRAS)  WJXBFS1
...
select	distinct 
	...
	count(pa11.DS_CMPR_COMPRA_EDIT)  DS_CMPR_COMPRA_EDIT,
...
from	ZZSP01	pa11
	...
	join	Siasg_DW_VBL.D_CMPR_MODALIDADE_COMPRA	a16
	  on 	(a13.ID_CMPR_MODALIDADE_COMPRA = a16.ID_CMPR_MODALIDADE_COMPRA)
group by a15.DS_DT_ANO, a16.DS_CMPR_MODALIDADE_COMPRA

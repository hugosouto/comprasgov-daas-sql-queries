...
from	Siasg_DW_VBL.F_ITEM_COMPRA	a11
	...
	join	ZZMQ00	pa15
	  on 	(a11.ID_ITCP_TP_COD_MAT_SERV = pa15.ID_ITCP_TP_COD_MAT_SERV and 
			...
			a14.ID_UNDD_ORGAO = pa15.ID_UNDD_ORGAO)
	join	Siasg_DW_VBL.D_ITCP_MATERIAL_SERVICO	a16
	  on 	(a11.ID_ITCP_TP_COD_MAT_SERV = a16.ID_ITCP_TP_COD_MAT_SERV)
where	(a16.ID_ITCP_GRUPO_MATERIAL in (89, 15, 91)
 and a13.ID_DT_ANO in (2023)
-- and a13.ID_DT_ANO in (2023,2022,2021,2020,2019,2018,2017,2016,2015)
 and a16.ID_ITCP_TP_MATERIAL_SERVICO in (1)
 and a16.ID_ITCP_PADRAO_DESC_MAT in ('826', '827', '828', '829', '830', '858', '859', '860', '880', '885', '890', '904', '905', '10165', '10166', '10167', '10168', '10169', '10170', '10171', '10172', '10182', '10186', '10192', '10193', '10194', '10195', '10196', '10197', '10198', '10199', '10200', '10201', '10202', '10203', '10204', '10205', '10206', '10209', '10210', '10522', '10572', '10713', '10988', '11267', '11269', '11377', '11381', '11400', '11657', '11855', '11927', '11928', '12046', '12168', '12182', '12428', '12438', '12481', '12544', '12545', '12546', '12992', '13020', '13213', '13214', '13234', '13318', '13335', '13388', '13527', '13542', '13860', '13864', '14248', '14691', '14695', '15008', '15031', '15209', '15604', '16128', '16172', '1637', '16733', '16734', '16735', '16736', '16737', '16738', '16739', '16740', '16741', '16742', '16743', '16794', '17294', '17296', '17310', '17312', '17313', '18328', '18712', '19586', '19690', '19714', '19737', '19739', '19740', '19741', '19742', '19763', '19770', '19771', '19772', '19773', '19789', '19790', '19791', '19792', '19793', '19794', '19935', '2137', '2156', '2206', '2207', '2276', '2300', '2327', '2339', '2398', '3043', '3151', '3161', '3267', '3437', '3439', '3509', '3510', '3516', '3678', '3909', '3933', '4069'))
-- and a16.ID_ITCP_PADRAO_DESC_MAT in ('588', '644', '645', '680', '7944', '7945', '8134', '8184', '822', '823', '824', '825', '826', '827', '828', '829', '830', '858', '859', '860', '880', '885', '890', '904', '905', '10165', '10166', '10167', '10168', '10169', '10170', '10171', '10172', '10182', '10186', '10192', '10193', '10194', '10195', '10196', '10197', '10198', '10199', '10200', '10201', '10202', '10203', '10204', '10205', '10206', '10209', '10210', '10522', '10572', '10713', '10988', '11267', '11269', '11377', '11381', '11400', '11657', '11855', '11927', '11928', '12046', '12168', '12182', '12428', '12438', '12481', '12544', '12545', '12546', '12992', '13020', '13213', '13214', '13234', '13318', '13335', '13388', '13527', '13542', '13860', '13864', '14248', '14691', '14695', '15008', '15031', '15209', '15604', '16128', '16172', '1637', '16733', '16734', '16735', '16736', '16737', '16738', '16739', '16740', '16741', '16742', '16743', '16794', '17294', '17296', '17310', '17312', '17313', '18328', '18712', '19586', '19690', '19714', '19737', '19739', '19740', '19741', '19742', '19763', '19770', '19771', '19772', '19773', '19789', '19790', '19791', '19792', '19793', '19794', '19935', '2137', '2156', '2206', '2207', '2276', '2300', '2327', '2339', '2398', '3043', '3151', '3161', '3267', '3437', '3439', '3509', '3510', '3516', '3678', '3909', '3933', '4069', '4357', '4507', '4548', '4550', '4551', '4552', '4553', '4554', '4555', '4556', '4557', '4558', '4559', '4560', '4716', '4717', '4742', '4857', '4948', '4949', '4952', '4964', '5295', '5301', '5305', '5381', '5950', '6064', '6065', '609', '611', '646', '6872', '6874', '701', '7018', '7425', '7426', '7650', '7652', '7847', '7849', '7853', '8025', '8088', '8097', '8272', '8369', '8530', '8722', '8749', '8750', '8751', '8928', '8935', '8990', '9058', '9088', '9114', '9382', '9510', '9764', '9805', '9806', '9807', '9808', '9905', '9906', '9911', '10029'))
group by	a14.ID_UNDD_ORGAO,
	a14.ID_UNDD_IN_SISG,
	a11.ID_ITCP_TP_COD_MAT_SERV,
	a13.ID_DT_ANO 
), ZZSP02  as (
select	a14.ID_UNDD_ORGAO  ID_UNDD_ORGAO,
	a14.ID_UNDD_IN_SISG  ID_UNDD_IN_SISG,
	a11.ID_ITCP_TP_COD_MAT_SERV  ID_ITCP_TP_COD_MAT_SERV,
	a13.ID_DT_ANO  ID_DT_ANO,
...
select	
	CASE
		...
		WHEN a17.ID_ITCP_CLASSE_MAT_SERV_EDIT IN (8905) 			THEN 'CARNES, AVES E PEIXES'
		WHEN a17.ID_ITCP_CLASSE_MAT_SERV_EDIT IN (8915) 			THEN 'HORTIFRUTIS'
		WHEN a17.ID_ITCP_CLASSE_MAT_SERV_EDIT IN (9130,9140,9150) 	THEN 'COMBUSTÍVEIS E LUBRIFICANTES'
	...
	a17.ID_ITCP_CLASSE_MAT_SERV_EDIT  ID_ITCP_CLASSE_MAT_SERV,
	...
	a16.DS_DT_ANO  DS_DT_ANO, --pa11.ID_DT_ANO  ID_DT_ANO,
...
from	ZZSP01	pa11
	join	ZZSP02	pa12
	  on 	(pa11.ID_DT_ANO = pa12.ID_DT_ANO and 
			...
			pa11.ID_UNDD_ORGAO = pa12.ID_UNDD_ORGAO)
	...
	join	Siasg_DW_VBL.D_UNDD_ORGAO	a14
	  on 	(pa11.ID_UNDD_ORGAO = a14.ID_UNDD_ORGAO)
	...
	join	Siasg_DW_VBL.D_UNDD_ORGAO_SUP	a110
	  on 	(a15.ID_UNDD_ORGAO_SUP = a110.ID_UNDD_ORGAO_SUP)
;